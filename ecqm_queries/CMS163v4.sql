...
CREATE TABLE results.measure_163_patient_base (
...
INSERT INTO results.measure_163_patient_base (base_patient_id)
SELECT base_patients.patient_id AS base_patient_id
FROM hqmf_test.patients AS base_patients
;

CREATE INDEX ix_measure_163_patient_base_patient_id ON results.measure_163_patient_base (base_patient_id)
;

---found pcsection 0

CREATE TABLE results.measure_163_conj_24 (
	patient_id INTEGER, 
...
INSERT INTO results.measure_163_conj_24 (patient_id, start_dt, end_dt, audit_key_value)
...
FROM
  (SELECT ordinal_1.hqmf_test_laboratory_test_performed_patient_id AS hqmf_test_laboratory_test_performed_patient_id,
          ...
          ordinal_1.row_number_17 AS row_number_17
   FROM
     (SELECT hqmf_test.laboratory_test_performed.patient_id AS hqmf_test_laboratory_test_performed_patient_id,
             ...
             CAST(row_number() OVER (PARTITION BY hqmf_test.laboratory_test_performed.patient_id
                                     ORDER BY coalesce(hqmf_test.laboratory_test_performed.start_dt, hqmf_test.laboratory_test_performed.end_dt) DESC) AS INTEGER) AS row_number_17
      FROM results.measure_163_patient_base,
      ...
      WHERE hqmf_test.laboratory_test_performed.patient_id = results.measure_163_patient_base.base_patient_id
   ...
   WHERE ordinal_1.row_number_17 = 1) AS dc_22 INTERSECT
...
FROM
  (SELECT hqmf_test.laboratory_test_performed.patient_id AS hqmf_test_laboratory_test_performed_patient_id,
   ...
   WHERE hqmf_test.laboratory_test_performed.patient_id = results.measure_163_patient_base.base_patient_id
     AND (CAST(hqmf_test.laboratory_test_performed.negation AS BOOLEAN) IS NULL
          OR CAST(hqmf_test.laboratory_test_performed.negation AS BOOLEAN) = false)
     AND hqmf_test.laboratory_test_performed.value < 100) AS dc_23
;

CREATE INDEX ix_measure_163_conj_24_patient_id ON results.measure_163_conj_24 (patient_id)
;


CREATE TABLE results.measure_163_conj_27 (
	patient_id INTEGER, 
	start_dt TIMESTAMP WITHOUT TIME ZONE, 
	end_dt TIMESTAMP WITHOUT TIME ZONE, 
	audit_key_value BIGINT
...
INSERT INTO results.measure_163_conj_27 (patient_id, start_dt, end_dt, audit_key_value)
SELECT dc_25.hqmf_test_laboratory_test_performed_patient_id AS patient_id,
       dc_25.hqmf_test_laboratory_test_performed_start_dt AS start_dt,
       dc_25.hqmf_test_laboratory_test_performed_end_dt AS end_dt,
       dc_25.hqmf_test_laboratory_test_performed_audit_key_value AS audit_key_value
FROM
  (SELECT ordinal_1.hqmf_test_laboratory_test_performed_patient_id AS hqmf_test_laboratory_test_performed_patient_id,
          ordinal_1.hqmf_test_laboratory_test_performed_start_dt AS hqmf_test_laboratory_test_performed_start_dt,
          ordinal_1.hqmf_test_laboratory_test_performed_end_dt AS hqmf_test_laboratory_test_performed_end_dt,
   ...
   FROM
     (SELECT hqmf_test.laboratory_test_performed.patient_id AS hqmf_test_laboratory_test_performed_patient_id,
      ...
      WHERE hqmf_test.laboratory_test_performed.patient_id = results.measure_163_patient_base.base_patient_id
        ...
        AND hqmf_test.laboratory_test_performed.end_dt <= CAST('2015-12-31T00:00:00' AS TIMESTAMP WITHOUT TIME ZONE)
        AND hqmf_test.laboratory_test_performed.value IS NOT NULL) AS ordinal_1
   WHERE ordinal_1.row_number_17 = 1) AS dc_25 INTERSECT
SELECT dc_26.hqmf_test_laboratory_test_performed_patient_id AS patient_id,
       dc_26.hqmf_test_laboratory_test_performed_start_dt AS start_dt,
       dc_26.hqmf_test_laboratory_test_performed_end_dt AS end_dt,
       dc_26.hqmf_test_laboratory_test_performed_audit_key_value AS audit_key_value
FROM
  (SELECT hqmf_test.laboratory_test_performed.patient_id AS hqmf_test_laboratory_test_performed_patient_id,
          hqmf_test.laboratory_test_performed.start_dt AS hqmf_test_laboratory_test_performed_start_dt,
          hqmf_test.laboratory_test_performed.end_dt AS hqmf_test_laboratory_test_performed_end_dt,
   ...
   WHERE hqmf_test.laboratory_test_performed.patient_id = results.measure_163_patient_base.base_patient_id
     AND (CAST(hqmf_test.laboratory_test_performed.negation AS BOOLEAN) IS NULL
          OR CAST(hqmf_test.laboratory_test_performed.negation AS BOOLEAN) = false)
     AND hqmf_test.laboratory_test_performed.value < 100) AS dc_26
;

CREATE INDEX ix_measure_163_conj_27_patient_id ON results.measure_163_conj_27 (patient_id)
;


CREATE TABLE results.measure_163_conj_38 (
	patient_id INTEGER, 
	start_dt TIMESTAMP WITHOUT TIME ZONE, 
	end_dt TIMESTAMP WITHOUT TIME ZONE, 
	audit_key_value BIGINT
...
INSERT INTO results.measure_163_conj_38 (patient_id, start_dt, end_dt, audit_key_value)
...
FROM
  (SELECT hqmf_test.encounter_performed.patient_id AS hqmf_test_encounter_performed_patient_id,
   ...
   WHERE hqmf_test.encounter_performed.patient_id = results.measure_163_patient_base.base_patient_id
...
CREATE INDEX ix_measure_163_conj_38_patient_id ON results.measure_163_conj_38 (patient_id)
;


CREATE TABLE results.measure_163_conj_45 (
	patient_id INTEGER, 
	start_dt TIMESTAMP WITHOUT TIME ZONE, 
	end_dt TIMESTAMP WITHOUT TIME ZONE, 
	audit_key_value BIGINT
...
INSERT INTO results.measure_163_conj_45 (patient_id, start_dt, end_dt, audit_key_value)
...
CREATE INDEX ix_measure_163_conj_45_patient_id ON results.measure_163_conj_45 (patient_id)
;

create or replace view results.measure_163_0_all as SELECT results.measure_163_patient_base.base_patient_id,
  ...
  (SELECT EXISTS
     (SELECT anon_1.patient_id,
             ...
             anon_1.row_number_2
      FROM
        (SELECT results.measure_163_conj_27.patient_id AS patient_id,
                results.measure_163_conj_27.start_dt AS start_dt,
                results.measure_163_conj_27.end_dt AS end_dt,
                results.measure_163_conj_27.audit_key_value AS audit_key_value,
                CAST(row_number() OVER (PARTITION BY results.measure_163_conj_27.patient_id
                                        ORDER BY coalesce(results.measure_163_conj_27.start_dt, results.measure_163_conj_27.end_dt)) AS INTEGER) AS row_number_2
         FROM results.measure_163_conj_27
         WHERE results.measure_163_conj_27.patient_id = results.measure_163_patient_base.base_patient_id) AS anon_1) AS xists) AS numerator,
             ...
             (SELECT anon_3.hqmf_test_diagnosis_active_patient_id,
              ...
              FROM
                (SELECT hqmf_test.diagnosis_active.patient_id AS hqmf_test_diagnosis_active_patient_id,
                 ...
                 WHERE hqmf_test.diagnosis_active.patient_id = results.measure_163_patient_base.base_patient_id
                   ...
                   AND (hqmf_test.diagnosis_active.end_dt >= CAST('2015-01-01T00:00:00' AS TIMESTAMP WITHOUT TIME ZONE)
                        ...
                        AND hqmf_test.diagnosis_active.end_dt IS NULL)) AS anon_3))
   AND (EXISTS
          (SELECT anon_4.hqmf_test_patient_characteristic_birthdate_patient_id,
           ...
           FROM
             (SELECT hqmf_test.patient_characteristic_birthdate.patient_id AS hqmf_test_patient_characteristic_birthdate_patient_id,
              ...
              WHERE hqmf_test.patient_characteristic_birthdate.patient_id = results.measure_163_patient_base.base_patient_id
                ...
                AND year_delta(hqmf_test.patient_characteristic_birthdate.start_dt, CAST('2015-01-01T00:00:00' AS TIMESTAMP WITHOUT TIME ZONE)) >= 18) AS anon_4))
   AND (EXISTS
           ...
           FROM
             (SELECT hqmf_test.patient_characteristic_birthdate.patient_id AS hqmf_test_patient_characteristic_birthdate_patient_id,
              ...
              WHERE hqmf_test.patient_characteristic_birthdate.patient_id = results.measure_163_patient_base.base_patient_id
                ...
                AND year_delta(hqmf_test.patient_characteristic_birthdate.start_dt, CAST('2015-01-01T00:00:00' AS TIMESTAMP WITHOUT TIME ZONE)) < 75) AS anon_5))
   AND (EXISTS
          (SELECT anon_6.patient_id,
                  anon_6.start_dt,
                  anon_6.end_dt,
                  anon_6.audit_key_value,
                  anon_6.row_number_13
           FROM
             (SELECT results.measure_163_conj_45.patient_id AS patient_id,
                     results.measure_163_conj_45.start_dt AS start_dt,
                     results.measure_163_conj_45.end_dt AS end_dt,
                     results.measure_163_conj_45.audit_key_value AS audit_key_value,
                     CAST(row_number() OVER (PARTITION BY results.measure_163_conj_45.patient_id
                                             ORDER BY coalesce(results.measure_163_conj_45.start_dt, results.measure_163_conj_45.end_dt)) AS INTEGER) AS row_number_13
              FROM results.measure_163_conj_45
              WHERE results.measure_163_conj_45.patient_id = results.measure_163_patient_base.base_patient_id
                AND results.measure_163_conj_45.start_dt >= CAST('2015-01-01T00:00:00' AS TIMESTAMP WITHOUT TIME ZONE)
                AND results.measure_163_conj_45.end_dt <= CAST('2015-12-31T00:00:00' AS TIMESTAMP WITHOUT TIME ZONE)) AS anon_6)) AS anon_2) AS "initialPopulation"
FROM results.measure_163_patient_base;
